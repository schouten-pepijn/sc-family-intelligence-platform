{# Canonical CBS region/year/measure mart.
   This combines the aggregation grain with readable dimension attributes so it can
   serve both analytical queries and downstream scorecards without an extra enrich layer. #}
